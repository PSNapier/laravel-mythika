...
<main>
	...
	<div class="h-[calc(100vh-9px-2px)] bg-stone-700 text-neutral flex justify-center">
			...
			<form class="form-control" method="POST" action="{{ route('login') }}">
				...
				<div class="block mt-4">
					<label for="remember_me" class="inline-flex items-center">
						<input id="remember_me" type="checkbox" class="checkbox checkbox-primary focus:ring-0 focus:ring-offset-0" name="remember">
